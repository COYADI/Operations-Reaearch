...
subject to reality1:
	sum{j in 1..3}Gsolar[j] + sum{j in 1..27}Gwater[j] + sum{j in 1..28}Gwind[j] + sum{j in 1..2}Gpump[j] >= 0.049 * avgDW;
subject to reality2:
	sum{j in 1..2}Gpump[j] >= 0.014 * avgDW;
subject to reality3:
	Ggaselec >= 0.02 * avgDW;
subject to reality4:
	sum{j in 1..2}Goil[j] >= 0.028 * avgDW;
subject to reality5:
	sum{j in 1..12}Ggas[j] >= 0.386 * avgDW;
subject to reality6:
	sum{j in 1..6}Gcoal[j] >= 0.388 * avgDW;
subject to reality7:
	sum{j in 1..3}Gnuclear[j] >= 0.114 * avgDW